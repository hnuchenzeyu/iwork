                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="Lyq-html/change.html">修改密码</a>
                                </li>
                                <li><a class="J_menuItem" href="profile.html">个人考勤</a>
                                </li>
                                <li><a class="J_menuItem" href="contacts.html">考勤记录</a>
                                </li>
                                <li><a class="J_menuItem" href="mailbox.html">请假</a>
                                </li>
                                <li class="divider"></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="index_v1.html" data-index="0">个人中心</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v2.html">财务模块</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v3.html">日程模块</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="index_v4.html">考勤模块</a>
                            </li>
                            <li>
                                <a href="index_v5.html" target="_blank">系统模块</a>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">考勤模块</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">活动</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#">福利<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="WelfareList">查看所有福利</a>
                                    </li>
                                    <li><a class="J_menuItem" href="release_activity.jsp">发布福利</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">公告<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li><a class="J_menuItem" href="ActivityList">查看所有公告</a>
                                    </li>
                                    <li><a class="J_menuItem" href="release_activity.jsp">发布公告</a>
                                    </li>
                                </ul>
                            </li>
